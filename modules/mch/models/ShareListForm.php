...
class ShareListForm extends MchModel
{
    ...
    public function getList()
    {
        if ($this->validate()) {
            ...
            // 分销金额
            $priceMap = OrderHelper::getSellerSalesMap($userIds, $this->store_id);
            foreach ($list as &$val) {
                $value['fx_total_price'] = isset($priceMap[$val['user_id']]) ? $priceMap[$val['user_id']] : 0;
            }
