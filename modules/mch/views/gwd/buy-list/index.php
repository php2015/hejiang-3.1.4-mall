    ...
    <div class="mb-3 clearfix" style="padding: 15px 0;">
        ...
        <div class="float-right">
            <a href="<?= $urlManager->createUrl([$urlStr . '/edit']) ?>" class="btn btn-primary"><i
                        class="iconfont icon-playlistadd"></i>导入购物单</a>
        </div>
    </div>
</div>
            ...
            <tr>
                ...
                <td class="order-tab-2">
                    <div class='titleColor'>总金额：<span
                        ...
                        <?php if ($item['express_price_1']) : ?>
                            (含运费：<span style="color:green;"><?= $item['express_price_1'] ?></span>元)</span>
                ...
                <td class="order-tab-5">
                    <a class="btn btn-sm btn-danger destroy"
                       href="<?= $urlManager->createUrl([$urlStr . '/destroy', 'id' => $item['order_id'], 'orderType' => $item['type']]) ?>">从购物单删除</a>
                </td>
